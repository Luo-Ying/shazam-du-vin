...
class Fluttertoast {
  ...
  static Future<bool?> showToast({
    ...
    if (gravity == ToastGravity.TOP) {
      ...
      gravityToast = "center";
    } else if (gravity == ToastGravity.TOP_MIDDLE) {
      gravityToast = "top middle";
    } else {
      gravityToast = "bottom";
    }
  ...
  _getPostionWidgetBasedOnGravity(Widget child, ToastGravity? gravity) {
    switch (gravity) {
      case ToastGravity.TOP:
        return Positioned(
            top: 80.0, bottom: 20.0, left: 24.0, right: 24.0, child: child);
      ...
      default:
        return Positioned(bottom: 80.0, left: 24.0, right: 24.0, child: child);
    }
  }
}
